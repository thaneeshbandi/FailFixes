...
const MessagesArea = styled(Box)(({ theme }) => ({
  ...
  "&::-webkit-scrollbar-thumb": {
    background:
      "linear-gradient(135deg, rgba(0,149,246,0.3), rgba(129,199,132,0.3))",
    borderRadius: "10px",
    "&:hover": {
      background:
        "linear-gradient(135deg, rgba(0,149,246,0.5), rgba(129,199,132,0.5))",
    },
  },
}));
...
function ChatWindow({ chat }) {
  ...
  return (
    <ChatContainer>
      <FloatingIcon top="8%" left="3%" delay={0} size="2rem">
        <Chat />
      </FloatingIcon>
      <FloatingIcon top="25%" left="90%" delay={1} size="1.8rem">
        <Message />
      </FloatingIcon>
      <FloatingIcon top="50%" left="2%" delay={2} size="2.2rem">
        <EmojiEmotions />
      </FloatingIcon>
      <FloatingIcon top="75%" left="92%" delay={3} size="1.5rem">
        <ThumbUp />
      </FloatingIcon>
      <SpinningIcon top="12%" right="8%" delay={0} size="1.8rem">
        <Favorite />
      </SpinningIcon>
      <SpinningIcon top="60%" right="5%" delay={2} size="1.6rem">
        <Star />
      </SpinningIcon>
      <SpinningIcon top="85%" right="10%" delay={4} size="2rem">
        <Send />
      </SpinningIcon>
        ...
        >
          <Box display="flex" alignItems="center">
            ...
            <Box flex={1}>
              ...
              <Typography
                variant="body2"
                sx={{ opacity: 0.95, fontSize: "0.85rem" }}
              >
                {chat.isGroupChat
